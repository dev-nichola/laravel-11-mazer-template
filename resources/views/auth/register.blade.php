            ...
            <div id="auth-left">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <x-form-input type="text" name="name" class="form-control-xl" placeholder="Fullname" :value="true" />
                        <x-form-icon icon="bi bi-person" />
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <x-form-input type="password" name="password_confirmation" class="form-control-xl" placeholder="Confirm Password" :value="false"/>
                        <x-form-icon icon="bi bi-shield-lock" />
